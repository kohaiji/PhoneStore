                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Product Variant
                                    </li>
                                </ol>
                            </nav>
                        </div>
...
{{--                    </form>--}}
                    ...
                    <a href="/admin/product-variant-add/{{$productId->product_id}}" class="btn btn-primary rounded-pill mt-3 mb-1">Add Variant</a>
                </div>
            </div>
                ...
                <table class="table table-light mb-0">
                    ...
                    @foreach($products as $obj)
                        <tr>
                            ...
                            <td>{{$obj->color}}</td>
                            <td>{{$obj->storage}}</td>
                            <td>{{$obj->price_adjustment}}</td>
                            <td>{{$obj->stock}}</td>
                            <td class="text-center">
                                <a href="/admin/product-variant-edit/{{$obj->id}}" class="btn btn-outline-primary btn-sm">Edit</a>
                            </td>
                            <td class="text-center">
                                <a onclick="return confirm('Are you sure?')" href="/admin/product-variant-delete/{{$obj->id}}" class="btn btn-outline-danger btn-sm">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
